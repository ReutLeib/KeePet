...
// if((isset($_POST["cats"]) && !empty($_POST["cats"]))) $query.=" AND cats='" . $_POST["cats"]."'";
// if((isset($_POST["dogs"]) && !empty($_POST["dogs"]))) $query.=" AND dogs='" . $_POST["dogs"]."'";
// if((isset($_POST["other"]) && !empty($_POST["other"])))  $query.=" AND other='" . $_POST["other"]."'";
                ...
                <div class="cardcontainer list">
                    <ul class="cardlist">
                        ...
                        if (isset($result)){
                            ...
                            $endDate = "05/01/18";
                            $preference = "Dog";
                            for ($i=0; $i < 100 ;$i++) include "card.php";
                            }
                        ?>
